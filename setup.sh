...
# Power Bank Investment System Setup Script

echo "Setting up Power Bank Investment System..."

# Create project directory
mkdir -p powerbank-investment
cd powerbank-investment
...
{
  "name": "powerbank-investment-backend",
  "version": "1.0.0",
  "description": "Backend for Power Bank Application + Investment Website",
  "main": "server.js",
  "scripts": {
...
{
  "name": "powerbank-investment-frontend",
  "version": "1.0.0",
  "description": "Frontend for Power Bank Application + Investment Website",
  "main": "index.js",
  "scripts": {
...
{
  "name": "powerbank-investment-admin",
  "version": "1.0.0",
  "description": "Admin Panel for Power Bank Application + Investment Website",
  "main": "index.js",
  "scripts": {
    "start": "react-scripts start",
    "build": "react-scripts build",
...
echo "Admin panel package.json created."

echo "Setup complete! To run the application:"
echo "1. Navigate to each directory (backend, frontend, admin) and run 'npm install'"
echo "2. Set up your PostgreSQL database and run the schema from database-schema.sql"
echo "3. Create .env files with your configuration"
echo "4. Run 'npm start' in each directory to start the services"